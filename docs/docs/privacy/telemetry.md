...
| `ai.quick_action.rewrite` | span | no | `preset`, `provider`, `was_local`, `tokens_in`, `tokens_out`, `latency_ms`, `error_class` | One Compose Quick Actions rewrite. `preset` records which of Improve / Shorter / Formal you picked, never your draft text. |
