...
Une petite barre d'outils IA apparait au-dessus du corps du message avec quatre boutons : **Ameliorer**, **Raccourcir**, **Formel** et **Corriger la grammaire**. Cliquez sur l'un d'eux pour que l'IA reecrive le texte actuel de votre brouillon.

MailCopilot affiche un panneau « Verifier la reecriture IA » comparant votre texte original (**Avant**) a la reecriture de l'IA (**Apres**). Choisissez **Remplacer** pour remplacer tout le brouillon par la reecriture, **Inserer au curseur** pour l'inserer a la position actuelle du curseur, ou **Annuler** pour rejeter la reecriture et laisser votre brouillon inchange. Le corps du message n'est modifie que si vous choisissez **Remplacer** ou **Inserer au curseur** -- **Annuler** laisse le brouillon inchange.

Les actions rapides necessitent un fournisseur IA configure (voir [Assistant IA](../ai-assistant)) et du texte dans le corps du message a reecrire. Voir [Actions rapides de redaction](../ai-assistant#actions-rapides-de-redaction) pour le comportement complet et les details de confidentialite.
