...
Sopra il corpo del messaggio appare una piccola barra degli strumenti IA con tre pulsanti: **Migliora**, **Accorcia** e **Formale**. Fai clic su uno di essi per far riscrivere all'IA il testo che hai scritto tu stesso -- il messaggio citato a cui stai rispondendo, qualsiasi intestazione di inoltro e la tua firma restano intatti, per risposte, inoltri e firme prodotti da MailCopilot stesso, e per le convenzioni di citazione diffuse degli altri client di posta. **Una bozza composta in un altro programma di posta può citare in uno stile che MailCopilot non riconosce -- su una bozza simile non viene trovato alcun confine, l'intero corpo conta come il tuo testo, e la citazione viene riscritta insieme ad esso.** Vedi l'elenco completo degli stili di citazione riconosciuti e non riconosciuti in [Azioni rapide nella composizione](../ai-assistant#azioni-rapide-nella-composizione).

MailCopilot mostra un pannello "Rivedi la riscrittura IA": il tuo testo e la riscrittura appaiono insieme come un unico passaggio scorrevole, con le modifiche evidenziate direttamente nel testo -- parole rimosse barrate, parole aggiunte evidenziate -- seguite da un elenco delle singole modifiche; copie in solo testo **Prima** / **Dopo** restano disponibili espandendo **Testo semplice**. Scegli **Sostituisci** per sostituire il tuo testo con la riscrittura (il messaggio citato e la firma sottostante restano invariati, se è stato trovato un confine -- vedi sopra), **Aggiungi sotto il mio testo** per inserirla alla fine del tuo testo, sopra qualsiasi messaggio citato, intestazione di inoltro o firma, oppure **Annulla** per scartare la riscrittura e lasciare la bozza invariata. Il corpo del messaggio viene modificato solo se scegli **Sostituisci** o **Aggiungi sotto il mio testo** -- **Annulla** lascia la bozza invariata.

Le Azioni rapide richiedono un provider IA configurato (vedi [Assistente IA](../ai-assistant)) e testo scritto da te, sopra a qualsiasi citazione, da riscrivere. **Correggere gli errori ha un pulsante proprio, più mirato** -- vedi [AI Proofread](../ai-assistant#ai-proofread) più sotto. Vedi [Azioni rapide nella composizione](../ai-assistant#azioni-rapide-nella-composizione) per il comportamento completo e i dettagli sulla privacy.

## AI Proofread

Accanto ai pulsanti di riscrittura, un pulsante **Check writing** elenca le correzioni suggerite -- ortografia, grammatica, punteggiatura e formulazione -- una alla volta, così puoi accettare ciascuna singolarmente invece di riscrivere tutto il testo. Questa funzione è **disattivata per impostazione predefinita, per casella**, e, a differenza delle funzioni lato lettura, resta visibile anche da disattivata: per una casella che non l'ha attivata, viene mostrata bloccata, con un suggerimento al passaggio del mouse che indica **Impostazioni → IA**, dove attivarla. Vedi [AI Proofread](../ai-assistant#ai-proofread) per il comportamento completo e i dettagli sulla privacy.

## Traduzione della bozza

Accanto ai pulsanti di riscrittura, un elenco **Traduci la bozza in** e un pulsante **Traduci** permettono di scrivere una risposta in una lingua diversa da quella in cui l'hai digitata. Anche questa funzione è **disattivata per impostazione predefinita, per casella** e usa la stessa autorizzazione **AI Translate** della traduzione del messaggio lato lettura; quando è disattivata, l'elenco e il pulsante restano visibili ma bloccati, con un suggerimento su dove attivarli, invece di scomparire. Scegli una lingua di destinazione -- oppure mantieni il suggerimento che MailCopilot potrebbe aver precompilato quando rispondi, la lingua rilevata del messaggio a cui stai rispondendo -- e fai clic su **Traduci**. Il risultato appare nello stesso pannello "Rivedi la riscrittura IA" usato sopra, con **Sostituisci**, **Aggiungi sotto il mio testo** e **Annulla**; nulla viene inserito nella tua bozza da solo. Viene tradotto solo il testo che hai scritto tu stesso -- il messaggio citato, l'intestazione di inoltro e la firma restano intatti, quando viene trovato un confine: qui si usa lo stesso rilevamento delle azioni rapide sopra, quindi una bozza composta in un altro programma di posta con uno stile di citazione non riconosciuto non presenta alcun confine e viene tradotta per intero, citazione compresa. Se la risposta del provider urta contro il proprio limite di lunghezza, o la bozza è troppo lunga per essere tradotta del tutto, il pulsante **Traduci** resta disabilitato invece di offrire un nuovo tentativo -- un altro clic sarebbe una richiesta a sé, fatturata, per lo stesso risultato; con gli altri rifiuti il pulsante torna cliccabile. Vedi [Traduzione della bozza](../ai-assistant#traduzione-della-bozza) per il comportamento completo e i dettagli sulla privacy.
