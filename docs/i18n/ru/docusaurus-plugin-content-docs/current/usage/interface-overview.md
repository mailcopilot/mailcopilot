...
- Тема письма
- Дата или время
- Индикатор непрочитанного (жирный текст) -- для цепочки строка выделяется жирным, если непрочитано **хотя бы одно** письмо цепочки из показанных сейчас в списке, а не только самое свежее. См. [Группировка в цепочки](./reading-emails#группировка-в-цепочки).
- Индикатор звёздочки
