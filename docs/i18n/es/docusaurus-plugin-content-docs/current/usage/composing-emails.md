...
Sobre el cuerpo del mensaje aparece una pequeña barra de herramientas de IA con cuatro botones: **Mejorar**, **Acortar**, **Formal** y **Corregir gramática**. Haga clic en uno para que la IA reescriba el texto que usted mismo ha escrito -- el mensaje citado al que está respondiendo, cualquier encabezado de reenvío y su firma permanecen intactos, para respuestas, reenvíos y firmas que ha producido el propio MailCopilot, así como para las convenciones de cita extendidas de otros clientes de correo. **Un borrador redactado en otro programa de correo puede citar con un estilo que MailCopilot no reconoce -- en un borrador así no se encuentra ninguna frontera, todo el cuerpo cuenta como su propio texto, y la cita se reescribe junto con él.** Consulte la lista completa de estilos de cita reconocidos y no reconocidos en [Acciones rápidas al redactar](../ai-assistant#acciones-rapidas-al-redactar).

MailCopilot muestra un panel "Revisar la reescritura de IA": su propio texto y la reescritura aparecen juntos como un único pasaje desplazable, con los cambios marcados directamente en el texto -- las palabras eliminadas tachadas, las añadidas resaltadas -- seguido de una lista de los cambios individuales; las copias en texto plano **Antes** / **Después** siguen disponibles al expandir **Texto plano**. Elija **Reemplazar** para sustituir su propio texto por la reescritura (el mensaje citado y la firma debajo permanecen sin cambios, si se encontró una frontera -- véase arriba), **Insertar en el cursor** para insertarla en la posición actual del cursor, o **Cancelar** para descartar la reescritura y dejar su borrador sin cambios. El cuerpo del mensaje solo se modifica si elige **Reemplazar** o **Insertar en el cursor** -- **Cancelar** deja el borrador sin cambios.

Las Acciones rápidas requieren un proveedor de IA configurado (consulte [Asistente IA](../ai-assistant)) y texto escrito por usted, encima de cualquier cita, para reescribir. Consulte [Acciones rápidas al redactar](../ai-assistant#acciones-rapidas-al-redactar) para el comportamiento completo y los detalles de privacidad.

## Traducción del borrador

Si la [traducción del borrador](../ai-assistant#traducción-del-borrador) está habilitada para esta cuenta, junto a la barra de herramientas de IA de arriba aparecen una lista **Traducir el borrador al** y un botón **Traducir**. Elija un idioma de destino -- o conserve la sugerencia que MailCopilot puede haber rellenado de antemano al responder, el idioma detectado del mensaje al que está respondiendo -- y haga clic en **Traducir**. El resultado aparece en el mismo panel "Revisar la reescritura de IA" usado arriba, con **Reemplazar**, **Insertar en el cursor** y **Cancelar**; nada se sustituye en su borrador por sí solo. Solo se traduce el texto que usted mismo escribió -- el mensaje citado, el encabezado de reenvío y la firma permanecen intactos, cuando se encuentra una frontera: esto usa la misma detección que las acciones rápidas de arriba, así que un borrador redactado en otro programa de correo con un estilo de cita no reconocido no tiene ninguna frontera y se traduce entero, cita incluida. La traducción del borrador comparte el mismo ajuste de cuenta que la traducción del mensaje en la lectura; no hay nada adicional que activar. Consulte [Traducción del borrador](../ai-assistant#traducción-del-borrador) para el comportamiento completo y los detalles de privacidad.
