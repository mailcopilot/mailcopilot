...
const i18nMap: Record<string, string> = {
  ...
  'settings.aiDestination.otherSettingsSaved': 'Your other changes on this screen were saved.',
...
describe('§2.119 AiDestinationRejectionNotice — what every reason must state', () => {
  ...
  it.each(reasons)('%s says the rest of the save landed', reason => {
    ...
    expect(line).toHaveTextContent('Your other changes on this screen were saved.')
